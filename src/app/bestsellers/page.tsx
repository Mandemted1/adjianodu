// NOTE: Place product images in public/images/collections/ (reuses same images)
// Editorial photo: public/images/bestsellers/editorial-model.png (different from collections one)
